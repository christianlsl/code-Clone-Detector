...
def compare_embeddings(
    ...
    return cluster_and_compare_embeddings(
        results=all_results,
        threshold=threshold,
...
def cluster_and_compare_embeddings(
    results: list[FileEmbeddingResult],
    threshold: float,
    dbscan_min_samples: int,
) -> list[dict[str, Any]]:
    """
    Performs clustering and comparison on a list of FileEmbeddingResult objects.
    """
    if not results:
        return []
...
def detect_clones(
    ...
    clusters = cluster_and_compare_embeddings(
        results=results,
        threshold=threshold,
        dbscan_min_samples=dbscan_min_samples,
    )
